...
{
	if (this->wallsTexture.loadFromFile("background/wallsHell.png") == false) //Init walls
	{
	...
	if (this->groundTexture.loadFromFile("background/groundHell.png") == false) //Init static ground
	{
